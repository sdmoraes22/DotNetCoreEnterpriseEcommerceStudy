...
namespace NSE.Identidade.Api.Extensions
{
    public class IdentityMensagensPortugues: IdentityErrorDescriber
    {
        ...
        public override IdentityError ConcurrencyFailure() { return new IdentityError { Code = nameof(ConcurrencyFailure), Description = "Falha de ocorrênca otimista, o objeto foi modificado." }; }
